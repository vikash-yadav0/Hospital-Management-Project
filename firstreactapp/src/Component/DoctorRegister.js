                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <button type="button" className="btn btn-light me-md-2" aria-current="page" onClick={() => navigate("/Admin")}>Go Back</button>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="registeresd pt-5">
                <div className="register-container">
                    <div className="container card w-50 ">
                        ...
                        <form className="register-form d-flex align-items-center flex-column " onSubmit={handleSubmit}>
                            <br></br>
                            <h1>Registration Form</h1>
                            <div className="mb-3 ">
                                <label htmlFor="user_email" class="form-label">Doctor Email :</label>
                                <input type="email" placeholder="email" name="user_email" id="email" onChange={(event) => {
                                    setuser_email(event.target.value);
                                }} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="doctor_name" class="form-label">Doctor Name :</label>
                                <input type="text" placeholder="name" name="doctor_name" id="doctor_name" onChange={(event) => {
                                    setdoctor_name(event.target.value);
                                }} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="doctor_contact" class="form-label">Doctor Contact :</label>
                                <input type="text" placeholder="contact" name="doctor_contact" id="doctor_contact" onChange={(event) => {
                                    setdoctor_contact(event.target.value);
                                }} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="qualifications" class="form-label">Qualifications :</label>
                                <input type="text" placeholder="MBBS/BAMS/MD" name="qualifications" id="qualifications" onChange={(event) => {
                                    setqualifications(event.target.value);
                                }} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="password" class="form-label">Password :</label>
                                <input type="password" name="password" placeholder="Password" id="password" onChange={(event) => {
                                    setpassword(event.target.value);
                                }} />

                            </div>
                            <div className="mb-3">
                            <label htmlFor="Dept" class="form-label">Department :</label>
                                <select name="deprt_id"onChange={(e) => {setdept_id(e.target.value);
                                }} >
                                    this.state.dept.map({dept =>{
